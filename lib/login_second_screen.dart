...
class LoginSecoundScreen extends StatefulWidget {
  const LoginSecoundScreen({Key? key}) : super(key: key);

  @override
  State<LoginSecoundScreen> createState() => _LoginSecoundScreenState();
}

class _LoginSecoundScreenState extends State<LoginSecoundScreen> {
  @override
